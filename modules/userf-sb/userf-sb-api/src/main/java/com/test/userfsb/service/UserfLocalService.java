...
/**
 * Provides the local service interface for Userf. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see UserfLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface UserfLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>com.test.userfsb.service.impl.UserfLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the userf local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link UserfLocalServiceUtil} if injection and service tracking are not available.
	 */
	public Userf addUserf(
		String name, String surname, String email, Date birthdate,
		Date creationdate);
